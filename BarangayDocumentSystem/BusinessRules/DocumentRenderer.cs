// =====================================================================
//  PART:    BusinessRules - lays a document out from its template, on screen and on paper
...
//  EDITS:   Clint Wood Gado - v3.1 renderer (Draft had a DocumentRenderer service by Jonathan; Fdraft a shorter one)
