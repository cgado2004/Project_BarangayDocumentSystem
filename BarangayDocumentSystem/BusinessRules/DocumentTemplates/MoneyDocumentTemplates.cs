// =====================================================================
//  PART:    Document templates - the v3.1 money documents (cedula, lupon filing, facility, Taripa)
...
public sealed class CommunityTaxTemplate : DocumentTemplateBase
{
    ...
    public CommunityTaxTemplate(FeeSchedule fees) : base(DocumentType.CommunityTaxCertificate)
    {
    ...
    protected override IEnumerable<string> Describe(DocumentRequest request, BarangayProfile barangay)
    {
        ...
        decimal additional = request.Fee - _fees.CommunityTaxBase;   // whatever is left of the fee is the income portion
        ...
        yield return "";
        yield return $"        Basic community tax ........................... {DisplayFormat.Peso(_fees.CommunityTaxBase)}";
        yield return $"        Sworn gross annual income ..................... {DisplayFormat.Peso(income)}";
        yield return $"        Additional tax, {DisplayFormat.Peso(_fees.CommunityTaxPerThousand)} per ₱1,000 of income ..... {DisplayFormat.Peso(Math.Max(0m, additional))}";
