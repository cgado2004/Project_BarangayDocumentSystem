...
namespace BarangayDocumentSystem.Helpers
{
    ...
    public static class ModernTheme
    {
        ...
        public static void StyleNavButton(Button b, bool active)
        {
            ...
            b.Font = F(10f, active);
            b.Cursor = Cursors.Hand;
            b.BackColor = active ? PrimaryNavy : Color.White;
            b.ForeColor = active ? Color.White : Muted;

            b.Paint -= PaintNavAccent;
            if (active) b.Paint += PaintNavAccent;
        }

        private static void PaintNavAccent(object sender, PaintEventArgs e)
        {
            var b = (Button)sender;
            e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
            using (var bar = new SolidBrush(Gold))
                e.Graphics.FillRectangle(bar, 0, 6, 4, b.Height - 12);
        }
    }
}
