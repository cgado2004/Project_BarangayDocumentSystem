...
namespace BarangayDocumentSystem.Services
{
    public class RequestService
    {
        ...
        {
            return Assess(residentId, type, ClearanceScope.Local);
        }

        public FeeAssessment Assess(int residentId, DocumentType type, ClearanceScope scope)
        {
            ...
            return feeSchedule.Assess(resident, type, scope);
        }
        ...
        public DocumentRequest Create(RequestDetails details)
        {
            ...
            var assessment = Assess(resident.ResidentId, details.DocumentType, details.Scope);
