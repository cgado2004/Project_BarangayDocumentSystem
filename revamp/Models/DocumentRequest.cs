...
namespace BarangayDocumentSystem.Models
{
    public class DocumentRequest
    {
        ...
        /// <summary>Local or abroad clearance scope. Carries the choice the
        /// clerk made on the request form; the fee was assessed from it.</summary>
        public ClearanceScope Scope { get; internal set; }
