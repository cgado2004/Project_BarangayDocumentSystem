...
namespace BarangayDocumentSystem.Data
{
    public static class SampleData
    {
        ...
        {
            var juan = CreateResident("Juan", "Dela Cruz", 35, "Purok 1");
            var maria = CreateResident("Maria", "Reyes", 68, "Purok 2");
            maria.IsSeniorCitizen = true;
            var jose = CreateResident("Jose", "Bautista", 22, "Purok 3");
            var ana = CreateResident("Ana", "Villanueva", 34, "Purok 4");
            ana.IsSoloParent = true;
            var pedro = CreateResident("Pedro", "Mendoza", 48, "Purok 5");
            pedro.IsIndigent = true;
            var liza = CreateResident("Liza", "Torres", 25, "Purok 2");
            liza.IsStudent = true;
            liza.IsPersonWithDisability = true;
            var carlo = CreateResident("Carlo", "Aquino", 23, "Purok 1");
            ...
            {
                ResidentId = juan.ResidentId, DocumentType = DocumentType.BarangayClearance, Purpose = "Employment requirement"
            });
